    ...
    return (
        <div>
            ...
            <div className="page-hero-banner pt-24" style={{
                background: project.coverGradient || 'linear-gradient(135deg, #1a1a3e 0%, #2e2870 35%, #1f0a2d 65%, #0f3d1e 100%)'
            }}>
                    ...
                    <div className="page-hero-content">
                        <div className="flex items-center gap-4 mb-4">
                            <Link
                                ...
                                className={`tag ${categoryColors[project.category]} hover:opacity-90 transition-opacity`}
                                style={{ 
                            ...
                            <span className="text-sm text-[var(--foreground-subtle)]" style={{ color: 'rgba(255,255,255,0.5)' }}>
                                {project.date}
                            </span>
                        </div>

                        <h1 className="page-hero-title !text-3xl md:!text-4xl lg:!text-5xl mb-2">
                            {project.title}
                        </h1>

                        {project.subtitle && (
                            <p className="text-sm text-[var(--foreground-subtle)] mb-6 font-medium" style={{ color: 'rgba(255,255,255,0.7)' }}>
                                {project.subtitle}
                            </p>
                        )}

                        <p className="page-hero-subtitle !max-w-none mb-8">
                            {project.description}
                        </p>
