                        ...
                        <ul className="space-y-2">
                            <li>
                                <a
                                    ...
                                    className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors inline-flex items-center gap-2"
                                >
                            ...
                            <li>
                                <a
                                    ...
                                    className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors inline-flex items-center gap-2"
                                >
                                    <OrcidIcon className="w-4 h-4 shrink-0 text-[var(--accent)]" />
                                    ORCID
                                </a>
                            </li>
                            <li>
